## This script will auto download all source files and check them with an MD5SUM ##
##      which I have provided since the developers do not provide an MD5SUM.     ##
...
## DEPENDENCIES ##
libtcd - found on my gitrepo https://github.com/KaMiila
